...
class GaussianDiffusion(nn.Module):
    ...
    def ddim_sample(self, shape, clip_denoised = True):
        ...
        img = torch.randn((1,1,1,5000), device = device)
    ...
    def sample(self, batch_size, cond):
        ...
        return sample_fn((batch_size, channels, image_size[0],image_size[1]),cond)
    ...
    def p_losses(self, x_start, t, cond, noise = None):
        ...
        loss = self.loss(model_out, target, reduction = 'none')
