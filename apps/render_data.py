...
def render_prt_ortho(out_path, folder_name, subject_name, shs, rndr, rndr_uv, im_size, angl_step=4, n_light=1, pitch=[0]):
    ...
    mesh_file = os.path.join(folder_name,folder_name.split('/')[-1]+'.obj')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', type=str, default='objs/0001_1.obj')
    parser.add_argument('-o', '--out_dir', type=str, default='meshes')
